...
const LoginPage = ()=>{
    ...
    const validationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
        email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().email("Enter a valid email address").required("Email is required"),
    ...
    const onSubmitHandler = async (values, helpers)=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$AxiosClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosClient"].post('/auth/login', values);
            const data = response.data;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(data?.msg || "Login Successful");
            localStorage.setItem("token", data.token);
            await fetchUserProfile();
            router.push("/");
            helpers.resetForm();
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error?.response?.data?.msg || "Login Failed");
        } finally{
            setLoading(false);
        }
    };
...
_s(LoginPage, "1FKEa8Pgmmzv8VvoNZtMn3GbY6Q=", false, function() {
    return [
...
//# sourceMappingURL=src_5eccb32a._.js.map