...
const RegisterPage = ()=>{
    ...
    const validationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
        ...
        ac_type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().oneOf([
            "saving",
            "current"
    ...
    const onSubmitHandler = async (values, helpers)=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$AxiosClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosClient"].post('/auth/register', values);
            const data = response.data;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(data?.msg || "Registered Successfully");
            localStorage.setItem("token", data.token);
            await fetchUserProfile();
            router.push("/");
            helpers.resetForm();
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error?.response?.data?.msg || "Something went wrong");
        } finally{
            setLoading(false);
        }
    };
...
_s(RegisterPage, "1FKEa8Pgmmzv8VvoNZtMn3GbY6Q=", false, function() {
    return [
...
//# sourceMappingURL=src_a1796fbd._.js.map